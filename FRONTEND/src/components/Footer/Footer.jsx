      ...
      <div className="footer-container">
        <div className="footer-section about">
          ...
          <div className="social-icons">
            <a href="https://www.facebook.com/profile.php?id=61580359182830" aria-label="Facebook"><i className="fab fa-facebook-f"></i></a>
            <a href="https://www.tiktok.com/@dauankinhky" aria-label="Tiktok"><i className="fab fa-tiktok"></i></a>
          </div>
        </div>
        ...
        <div className="footer-section contact-subscribe">
          ...
          <p><i className="fas fa-map-marker-alt"></i> Trường Đại Học FPT - Hà Nội</p>
          <p><i className="fas fa-phone"></i> Hotline: 039 292 0491</p>
          <p><i className="fas fa-envelope"></i> Email: dauankinhky@gmail.com</p>
